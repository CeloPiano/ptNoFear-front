    ...
    return (
        <div>
            <button 
                ...
                ("text-gray-400 w-[100%] justify-between bg-white hover:bg-gray-200 focus:outline-none  font-medium rounded-sm text-sm px-4 py-2.5 text-center inline-flex") 
                :("text-black w-[100%] justify-between bg-white hover:bg-gray-200 focus:outline-none font-medium rounded-sm text-sm px-4 py-2.5 text-center inline-flex")} type="button">
                {props.Content}
